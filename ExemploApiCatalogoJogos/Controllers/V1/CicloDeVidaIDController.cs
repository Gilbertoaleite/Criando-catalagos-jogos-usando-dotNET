...
#pragma warning disable CS0592 // Atributo "HttpGet" não é válido neste tipo de declaração. Ele é válido somente em "método" declarações.
        [HttpGet]
#pragma warning restore CS0592 // Atributo "HttpGet" não é válido neste tipo de declaração. Ele é válido somente em "método" declarações.
